...
; if it closes, press screen button to re-open it. name "keycount"
org 100h
...
stop: mov dx, offset msg2 mov ah, 9
int 21h
...
print_ax proc cmp ax, 0

jne print_ax_r push ax 


    mov al, '0' mov ah, 0eh int 10h
pop ax ret
print_ax_r: pusha mov dx, 0
cmp ax, 0 je pn_done mov bx, 10 div bx
call print_ax_r mov ax, dx add al, 30h mov ah, 0eh int 10h
jmp pn_done pn_done:
popa ret
endp
